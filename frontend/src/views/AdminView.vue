  ...
  >
    ...
    >
      <div class="flex flex-col items-center gap-3">
        ...
        ></div>
        <span
          class="text-charcoal-light dark:text-dark-text-secondary text-sm font-body"
          >Loading...</span
        >
      </div>
    </div>
    ...
    <template v-else>
      ...
      <ForcedPasswordChangeModal
        ...
        @update:show-confirm-new-password="
          showConfirmNewPasswordForChange = $event
        "
        ...
        <div class="overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0">
          ...
          >
            ...
            >
              ...
              <span v-if="activeTab === tab.key" class="sm:hidden">{{
                tab.label
              }}</span>
            </button>
          </div>
