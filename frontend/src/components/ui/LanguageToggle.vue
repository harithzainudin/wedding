...
const { currentLanguage, currentLanguageName, setLanguage, languages } =
  useLanguage();

const buttonClasses = computed(() => {
  const base =
    "flex items-center gap-1 px-3 py-2 backdrop-blur-sm border rounded-full cursor-pointer transition-all duration-300 active:scale-95";
