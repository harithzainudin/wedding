    ...
    <div class="max-w-xl mx-auto text-center">
      ...
      <div class="space-y-4 sm:space-y-5">
        ...
        <ParkingGuide
          ...
          :translations="{
            parkingGuide: t.parking?.guide ?? 'Parking Guide',
            tapToExpand: t.parking?.tapToExpand ?? 'Tap for details',
            directions: t.parking?.directions ?? 'Directions',
            videoGuide: t.parking?.videoGuide ?? 'Video Guide',
          }"
        />
      </div>
