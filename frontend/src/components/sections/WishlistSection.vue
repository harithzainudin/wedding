      ...
      <div v-else>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <div
            ...
            :class="[
              'bg-white dark:bg-dark-bg-secondary rounded-xl shadow-sm dark:shadow-lg overflow-hidden flex flex-col transition-all duration-300 cursor-pointer hover:shadow-md hover:scale-[1.02]',
