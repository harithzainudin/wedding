      ...
      <div v-if="isLoadingContacts" class="grid gap-3 sm:gap-4">
        ...
        >
          <div class="flex-1 space-y-2">
            <div
              class="h-5 sm:h-6 w-32 bg-charcoal/10 dark:bg-dark-text/10 rounded"
            ></div>
            <div
              class="h-4 w-24 bg-charcoal/5 dark:bg-dark-text/5 rounded"
            ></div>
          </div>
          <div class="flex gap-2">
            <div
              class="w-11 h-11 sm:w-12 sm:h-12 bg-sage/30 rounded-full"
            ></div>
            <div
              class="w-11 h-11 sm:w-12 sm:h-12 bg-[#25D366]/30 rounded-full"
            ></div>
          </div>
        </div>
      </div>
