    ...
    <div class="max-w-xl mx-auto text-center">
      ...
      <div class="grid gap-3 sm:gap-4">
        <button
          ...
          :key="contact.phone"
          type="button"
          class="flex items-center gap-3 sm:gap-4 p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow cursor-pointer active:scale-[0.98]"
          @click="openWhatsApp(contact.phone)"
        >
          <!-- WhatsApp Icon -->
          <div class="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center bg-[#25D366] rounded-full">
