  ...
  <div class="space-y-2">
    ...
    <div class="space-y-0">
      ...
      >
        ...
        >
          <div class="w-3 h-3 rounded-full bg-sage border-2 border-white dark:border-dark-bg-secondary shadow-sm"></div>
        ...
        >
          <svg v-if="previewingId === track.id" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
