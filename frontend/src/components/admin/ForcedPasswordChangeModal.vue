    ...
    <div class="bg-white dark:bg-dark-bg-secondary rounded-xl p-6 max-w-md w-full shadow-xl">
      <div class="text-center mb-6">
        <div class="w-14 h-14 bg-amber-100 dark:bg-amber-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
          <svg class="w-7 h-7 text-amber-600 dark:text-amber-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
            <path d="M7 11V7a5 5 0 0110 0v4" />
          </svg>
        </div>
        <h3 class="font-heading text-xl text-charcoal dark:text-dark-text mb-2">Password Change Required</h3>
      ...
      <form @submit.prevent="emit('submit')" class="space-y-4">
        <div>
          <label for="forcedNewPassword" class="block font-body text-sm font-medium text-charcoal dark:text-dark-text mb-1">
            New Password
          </label>
          <div class="relative">
            <input
        ...
        <div>
          <label for="forcedConfirmNewPassword" class="block font-body text-sm font-medium text-charcoal dark:text-dark-text mb-1">
