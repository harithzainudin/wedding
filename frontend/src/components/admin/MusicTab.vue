    ...
    <div v-else class="space-y-6">
      ...
      <div v-else class="p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
        <p class="font-body text-sm text-amber-700 dark:text-amber-300">
          Maximum number of tracks ({{ settings.maxTracks }}) reached. Delete some tracks to upload more.
        </p>
      </div>

      <!-- Empty State -->
      <div v-if="tracks.length === 0" class="text-center py-12 bg-white dark:bg-dark-bg-secondary rounded-xl border border-sand-dark dark:border-dark-border">
