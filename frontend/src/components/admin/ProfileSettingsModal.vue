  ...
  >
    <div class="bg-white dark:bg-dark-bg-secondary rounded-xl p-6 max-w-md w-full shadow-xl">
      <div v-if="success" class="text-center">
        ...
        <p class="font-body text-sm text-charcoal-light dark:text-dark-text-secondary">Your profile has been updated successfully.</p>
      </div>
      ...
      <div v-else>
        ...
        <div v-if="isLoading" class="text-center py-8">
          ...
          <p class="font-body text-sm text-charcoal-light dark:text-dark-text-secondary mt-3">Loading profile...</p>
        </div>
        ...
        <form v-else @submit.prevent="emit('save')" class="space-y-4">
          <div>
            ...
            <div class="w-full px-3 py-2.5 font-body text-base border border-sand-dark dark:border-dark-border rounded-lg bg-sand-dark/30 dark:bg-dark-bg-elevated text-charcoal-light dark:text-dark-text-secondary">
              {{ username }}
            </div>
          ...
          <div v-if="!isMasterUser">
            <label for="profileEmail" class="block font-body text-sm font-medium text-charcoal dark:text-dark-text mb-1">
              Email
            </label>
            <input
              id="profileEmail"
          ...
          <div v-if="isMasterUser" class="p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
