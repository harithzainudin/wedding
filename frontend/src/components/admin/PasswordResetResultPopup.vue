    ...
    <div class="bg-white dark:bg-dark-bg-secondary rounded-xl p-6 max-w-md w-full shadow-xl">
      <div class="text-center">
        ...
        <template v-if="!needsManualSharing">
          ...
          <h3 class="font-heading text-lg text-charcoal dark:text-dark-text mb-2">Password Reset Successfully</h3>
          <p class="font-body text-sm text-charcoal-light dark:text-dark-text-secondary mb-4">
            A password reset email has been sent to "{{ username }}". They will be required to change their password after logging in.
          </p>
          <button
            type="button"
        ...
        <template v-else>
          ...
          <div class="bg-sand dark:bg-dark-bg-elevated rounded-lg p-4 mb-4 text-left">
            <div class="mb-3">
              <p class="font-body text-xs text-charcoal-light dark:text-dark-text-secondary uppercase tracking-wide mb-1">Username</p>
              <p class="font-body text-base text-charcoal dark:text-dark-text font-semibold">{{ username }}</p>
            </div>
            <div class="border-t border-sand-dark dark:border-dark-border pt-3">
              <p class="font-body text-xs text-charcoal-light dark:text-dark-text-secondary uppercase tracking-wide mb-1">Temporary Password</p>
              <p class="font-mono text-base text-charcoal dark:text-dark-text font-semibold">{{ temporaryPassword }}</p>
            </div>
          </div>
