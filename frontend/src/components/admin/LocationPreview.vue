    ...
    <div class="p-4 space-y-4">
      <div v-if="hasContent">
        ...
        <div v-if="venueName.trim()">
          <p
            class="font-body text-xs text-charcoal-light dark:text-dark-text-secondary mb-1"
          >
            Venue
          </p>
        ...
        <div v-if="address.trim()">
          ...
          <p
            class="font-body text-sm text-charcoal dark:text-dark-text whitespace-pre-line"
          >
            {{ address }}
          </p>
        </div>
      ...
      <!-- Navigation Buttons -->
      <div
        class="pt-3 border-t border-sand-dark/50 dark:border-dark-border/50 space-y-2"
      >
        <p
        ...
        <div class="flex gap-2">
          ...
          >
            ...
            <span
              class="font-body text-xs font-medium text-charcoal dark:text-dark-text"
              >Maps</span
            >
            <svg
        ...
        <div class="mt-3 space-y-1">
          <div class="flex items-start gap-2">
            <span
              class="font-body text-xs text-charcoal-light dark:text-dark-text-secondary shrink-0"
              >Maps:</span
            >
            <p class="font-body text-xs text-sage break-all">
              {{ googleMapsUrl }}
            </p>
          </div>
          <div class="flex items-start gap-2">
