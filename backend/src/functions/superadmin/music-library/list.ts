/**
 * List Global Music Library Endpoint (Super Admin Only)
 *
 * Returns all tracks in the global music library.
 * Route: GET /superadmin/music-library
 *
 * Query Parameters:
...
export const handler: APIGatewayProxyHandlerV2 = async (event, context) => {
  try {
    ...
    logError(
      {
        endpoint: 'GET /superadmin/music-library',
        operation: 'list-global-music',
