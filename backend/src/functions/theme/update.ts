/**
 * Update Theme Endpoint (Admin)
 *
 * Updates theme settings for a specific wedding.
 * Route: PUT /admin/w/{weddingId}/theme
 *
...
export const handler: APIGatewayProxyHandlerV2 = async (event, context) => {
  ...
  try {
    ...
    logError(
      {
        endpoint: 'PUT /admin/w/{weddingId}/theme',
        operation: 'updateTheme',
        requestId: context.awsRequestId,
        input: { weddingId, activeThemeId: validation.data.activeThemeId },
      },
      error
    )
